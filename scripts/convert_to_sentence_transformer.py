...
parser.add_argument('--half', type=int, default=0, choices=[0, 1], help='Specify half precision, default 0')
...
if args.push_to_hub:
    model.push_to_hub(args.hub_model_id, private=args.hub_private_repo == 1, exist_ok=True)
